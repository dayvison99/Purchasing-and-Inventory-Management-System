            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5>Conferir Estoque Januária</h5>
                    </div>
                    ...
                    <?php
                        ...
                        //3º Reinicie o servidor http
                            try{
                                ...
                                $result = "DELETE FROM `auxestoquejn`";
                                $queryresult = mysqli_query($con, $result);
                                $zerar = "ALTER TABLE `auxestoquejn` AUTO_INCREMENT=1";
                        ...
                        if ($queryexcluir){
                                    $zerar1 = "ALTER TABLE `leitorjn` AUTO_INCREMENT=1";
                      ...
                      ?>
                        ...
                        <br/>
                          ...
                          <a class="btn btn-primary" href="leitorjn.php">OK</a>
