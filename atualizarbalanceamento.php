...
//3º Reinicie o servidor http
    try{
        ...
        require_once 'lj/getBalanceamento.php';
        ...
        // $jsonprdutosbm = json_decode($produtosbm);
         ...
         //
         // $resultproduto = "DELETE FROM `est004` where CODPRODUTO >= 67000";
        ...
        foreach($jsonprdutosjn->LJSISTEMAS as $dados):
            $empresa = $dados->EMPRESA;
            // $codproduto = $dados->CODPRODUTO;
            // $descricao = $dados->DESCPRODUTO;
            // $referencia = $dados->REFERENCIA;
            // $estatual = $dados->ESTOQUE;
            // $precocusto = $dados->PRECOCUSTO;

            $resultprodutojn = "INSERT INTO cvs(`EMPRESA`) VALUES('$empresa');
              -- ,`CODPRODUTO`,`DESCPRODUTO`,`REFERENCIA`,`ESTATUAL`,`PRECOFINAL`) VALUES ('$empresa','$codproduto','$descricao','$referencia','$estatual','$precocusto')";
            $queryresultproduto = mysqli_query($con, $resultprodutojn);
