...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="jumbotron" id="tabela"><center>
      <table id="tabela" class="table table-striped table-bordered table-condensed table-hover" title="Balanceamento!">
        <tr >
          ...
          <th colspan=""><a href="imprimirjn-sf-excel.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Gerar Excel</button></a></li></th>
    ...
    function CriaPDF() {
      ...
      win.document.write('<title>Balanceamento Januária para São Francisco</title>');   // <title> CABEÇALHO DO PDF.
