                ...
                <div class="container-fluid">
                  ...
                  <!-- Confimar ser o usuario deseja sair sem salvar-->
                    ...
                    <div class="row">
                      ...
                      <form action="importarEstPorMarca2.php" method="post" enctype="multipart/form-data" >
                        <div class="form-group">
                    ...
                    <div>
                      ...
                      <div class="row">
                        ...
                        <form action="importarEstPorMarca3.php" method="post" enctype="multipart/form-data" >
                          <div class="form-group">
                            <label for="exampleFormControlFile1">Escolha seu arquivo (txt)</label>
                            <input type="file" class="form-control-file" name="arquivo"  required>
                          </div>
