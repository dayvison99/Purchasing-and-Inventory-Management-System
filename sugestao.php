...
<div class="jumbotron"><center>
  ...
  <legend class="legend-border"><h4> Balanceamento Saíndo de Januária </h4></legend>
  <form action="" method="post" class="form">
    ...
    <table id="tabela" class="table table-striped table-bordered table-condensed table-hover" title="Balanceamento!">
      ...
      while($rowjn = mysqli_fetch_assoc($lojasresult)) {
        ...
        if ($rowjn['jnestaual'] > $rowjn['jnestminino']){
          echo "<td>" .$difjn;"</td>";
        }
        else{
          echo "<td>-</td>";
        ...
        #se estoque de atual de jn for maior que o estoque minino e estoque de bm atual for menor qu o minino
        #se estoque de atual de jn for maior que o estoque minino e estoque de sf atual for menor qu o minino
