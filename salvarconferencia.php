...
$salvar = "SELECT * FROM salvarconferencia order by substr(data,7,4) desc,substr(data,1,2) desc";
...
if ($_SESSION['empresa'] == 1) {
  ...
  $sql = "SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto as lcodigo,l.quantidade as lqtde FROM auxestoquejn as e left JOIN leitorconferenciajn as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo UNION SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto  as lcodigo,l.quantidade  as lqtde FROM auxestoquejn as e inner  JOIN leitorconferenciajn as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by lcodigo ";
...
if ($_SESSION['empresa'] == 2) {
  ...
  $sql = "SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto as lcodigo,l.quantidade as lqtde FROM auxestoquesf as e left JOIN leitorconferenciasf as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo UNION SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto  as lcodigo,count(l.codproduto) as lqtde FROM auxestoquesf as e inner  JOIN leitorconferenciasf as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo ";
  $result = mysqli_query($con, $sql);
...
if ($_SESSION['empresa'] == 5) {
  ...
  $sql = "SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto as lcodigo,l.quantidade as lqtde FROM auxestoquebm as e left JOIN leitorconferenciabm as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo UNION SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto  as lcodigo,count(l.codproduto) as lqtde FROM auxestoquebm as e inner  JOIN leitorconferenciabm as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo ";
  $result = mysqli_query($con, $sql);
...
if ($_SESSION['empresa'] == 6) {
  $leitor = "SELECT e.CODPRODUTO,e.CONTAPRODUTO,e.DESCPRODUTO as descricao, l.CODPRODUTO as codigo, count(l.codproduto) as quantidade FROM est004 as e INNER JOIN leitorconferenciamaimai as l ON l.codproduto = e.CONTAPRODUTO where e.empresa = 1 and l.usuario = $usuario group by l.codproduto order by descricao  ";
  $leitorresult = mysqli_query($con, $leitor);

  $sql = "SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto as lcodigo,l.quantidade as lqtde FROM auxestoquemaimai as e left JOIN leitorconferenciamaimai as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo UNION SELECT e.codproduto as tcodigo,e.DESCPRODUTO as tnome, e.estoque as tentrada, l.id,l.codproduto  as lcodigo,count(l.codproduto) as lqtde FROM auxestoquemaimai as e inner  JOIN leitorconferenciamaimai as l ON l.codproduto = e.CONTAPRODUTO where l.usuario = $usuario group by tcodigo ";
  $result = mysqli_query($con, $sql);
  $totalsistema = 0;
  $totalleitor = 0;
}
