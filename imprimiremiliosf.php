      ...
      <div class="jumbotron" id="tabela"><center>
        <table id="tabela" class="table table-striped table-bordered table-condensed table-hover" title="Balanceamento!">
           <tr >
             ...
             <th></th>
             <th></th>
             <th><a class="btn btn-primary" href="marcassf.php">Voltar</a></th>
             <th><a class="btn btn-primary" onclick="CriaPDF()" href="marcassf.php">Imprimir</a></th>
...
function CriaPDF() {
    ...
    win.document.write('<title>Lista de Compras São Francisco</title>');   // <title> CABEÇALHO DO PDF.
