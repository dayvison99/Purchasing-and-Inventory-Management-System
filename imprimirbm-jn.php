      ...
      <div class="jumbotron" id="tabela"><center>
        <table id="tabela" class="table table-striped table-bordered table-condensed table-hover" title="Balanceamento!">
           <tr >
             ...
             <th colspan=""><a href="imprimirbm-jn-excel.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Gerar Excel</button></a></li></th>
                                   ...
                                   #Jn precinsando de BM
                                     ...
                                     if($rowjn['jnestaual'] <= $rowjn['jnestminino'] and  $rowsf['sfestaual'] < $rowsf['sfestminino'] ){
                                          ...
                                          if($rowsf['sfestminino'] - $rowsf['sfestaual'] <=  $difbm-($rowjn['jnestminino'] - $rowjn['jnestaual'])){
                                              # echo "<td>".($rowsf['estminino'] - $rowsf['estaual']);"</td>";

                                          }
                                          if($rowsf['sfestminino'] - $rowsf['sfestaual'] >  $difbm-($rowjn['jnestminino'] - $rowjn['jnestaual'])){
                                              if($difbm-($rowjn['jnestminino'] - $rowjn['jnestaual'])>0){
                                           #echo "<td>".($difbm-($rowjn['estminino'] - $rowjn['estaual']));"</td>";
                                              }
                                          }
                                    }
                               }
...
function CriaPDF() {
    ...
    win.document.write('<title>Balanceamento Brasília para Januária</title>');   // <title> CABEÇALHO DO PDF.
