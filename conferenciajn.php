...
<div class="form-group col-xs-6" >
      ...
      <?php
           ...
           $leitor = "SELECT e.CODPRODUTO  as CONTAP,e.DESCPRODUTO as descricao, l.CODPRODUTO as codigo, count(l.codproduto) as quantidade FROM auxestoquejn as e INNER JOIN leitorjn as l ON l.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by l.codproduto order by descricao  ";
           $leitorresult = mysqli_query($con, $leitor);

           $sql = "SELECT e.estoque, e.codproduto  as CONTAP,e.descricao as descricao, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde  FROM auxestoquejn as e INNER JOIN leitorjn as l ON l.codproduto = e.CODPRODUTO group by e.CODPRODUTO  UNION SELECT e.estoque,e.codproduto  as CONTAP,e.descricao as descricao, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM auxestoquejn as e INNER JOIN leitorjn as l ON l.codproduto = e.CODPRODUTO group by e.CODPRODUTO ";
