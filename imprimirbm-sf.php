    ...
    <div id="wrapper">
      ...
      <div class="jumbotron" id="tabela"><center>
        ...
        <tr >
             ...
             <th><a class="btn btn-primary" href="sugestaobm.php">Voltar</a></th>
             <th colspan=""><a href="imprimirbm-sf-excel.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Gerar Excel</button></a></li></th>

             <th><a class="btn btn-primary" onclick="CriaPDF()" href="sugestaobm.php">Imprimir</a></th>
      ...
      <?php
        while($rowjn = mysqli_fetch_assoc($lojasresult)) {
            $rowbm = $rowjn ;
            $rowsf = $rowjn ;
            if ($rowbm['bmestaual'] > $rowbm['bmestminino']  and $rowsf['sfestaual'] < $rowsf['sfestminino'] and $rowbm['bmestaual'] - $rowbm['bmestminino'] > $rowjn['jnestminino']-$rowjn['jnestaual'] and $rowjn['jnestminino']-$rowjn['jnestaual'] >=0  ){
...
<script>
    function CriaPDF() {
        ...
        win.document.write('<title>Balanceamento Brasilia para São Francisco</title>');   // <title> CABEÇALHO DO PDF.
