            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Sugestão de Compras Por Marcas</h1>
...
<form action='sugestaomarcas.php' method='post' name="formgrupo">
  <select name="marca" class="form-control"   required>

    <option value="" selected disabled required>MARCAS</option>

  <?php
    $getmarcas = "SELECT * FROM est017 where empresa = 1  order by DESCMARCA  ";
    $queryresult = mysqli_query($con, $getmarcas);
    while($querymarcas = mysqli_fetch_assoc($queryresult)) {
            $todasmarcas = $querymarcas['DESCMARCA'];
            $idmarcas = $querymarcas['MARCACONTADOR'];
            echo "  <option value='$idmarcas'>$todasmarcas</option>";
               }
            $cont = $_POST["marca"];
...
<div class="form-group col-xs-3">   <h1 class="h3 mb-0 text-gray-800">  - </h1>
  </div>
  ...
  <input type="submit" class="btn btn-primary" value="Buscar"/>
      ...
      <?php
          #  $grupos = $_POST["grupo"];
            ...
            if ($cont == false){
                        ...
                        $jn = "SELECT * FROM cvs as c INNER JOIN est004 as e ON e.CODPRODUTO = c.codproduto where e.MARCA = $cont";
                        $jnresult = mysqli_query($con, $jn);
            ...
            $grupo = "SELECT * FROM est002 as g INNER JOIN est004 as e ON e.GRUPO = g.GRUPOCONTADOR inner join cvs as c ON e.CODPRODUTO = c.codproduto where g.EMPRESA = 1";
      ...
      <?php
                 ...
                 while($rowjn = mysqli_fetch_assoc($jnresult)) {
                  ...
                  $rowgrupo = mysqli_fetch_assoc($gruporesult);
                  echo "<tr >";
