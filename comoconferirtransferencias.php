    ...
    <div id="wrapper">
      ...
      <!-- End of Sidebar -->
        ...
        <!-- End of Sidebar -->
               ...
               <table class="table_painel">
                 <tr class="tr_icone_painel">
                   <td class="td_icone_painel" subId="5">
                           ...
                           <h4><center>Como Puxar O Relatorio de Transferencias No SIG.</h4>
              ...
              <tr class="tr_icone_painel">
               <td class="td_icone_painel" subId="5">
                 ...
                 <div class="embed-responsive embed-responsive-16by9">
                   <iframe class="embed-responsive-item" src="/videos/relatoriotransferencia.mp4"></iframe>
                 </div>
               </td>
             </tr>
             <tr class="tr_icone_painel">
         ...
         <!-- 16:9 aspect ratio -->
                   <div class="embed-responsive embed-responsive-16by9">
                     <iframe class="embed-responsive-item" src="/videos/importartransferencia.mp4"></iframe>
                   </div>
                  </td>
                  </tr>
        </table>
