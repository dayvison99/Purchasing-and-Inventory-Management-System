                    ...
                    $idusuario =  $_SESSION['UsuarioID'];
                      ...
                      if ($_SESSION['empresa'] == "1"){
                        $result = mysqli_query($con,"SELECT * FROM comprasjn");
                              ...
                              if ($queryresult){
                                          $zerar = "ALTER TABLE `comprasjn` AUTO_INCREMENT=1";
                                          $queryresult = mysqli_query($con, $zerar);
                                          $zerar1 = "ALTER TABLE `leitorcomprasjn` AUTO_INCREMENT=1";
                        ...
                        if ($_SESSION['empresa'] == "2"){
                                ...
                                if ($queryresult){
                                          ...
                                          $queryresult = mysqli_query($con, $zerar);
                                          $zerar1 = "ALTER TABLE `leitorcomprassf` AUTO_INCREMENT=1";
                                          $queryresult = mysqli_query($con, $zerar1);
                                          echo "Dados Excluídos com Sucesso";
                              }else{
                                          echo "Erro na exclusão";
                        ...
                        if ($_SESSION['empresa'] == "5"){
                              ...
                              if ($queryresult){
                                         ...
                                         $queryresult = mysqli_query($con, $zerar);
                                         $zerar1 = "ALTER TABLE `leitorcomprasbm` AUTO_INCREMENT=1";
                                         $queryresult = mysqli_query($con, $zerar1);
                                         echo "Dados Excluídos com Sucesso";
                              }else{
                                          echo "Erro na exclusão";
