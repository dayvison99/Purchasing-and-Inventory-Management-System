...
<div class="form-group col-xs-6" >
      ...
      <?php
           ...
           $sql = "SELECT e.codproduto  as CONTAP,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e INNER JOIN leitorbm as l ON l.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by e.descproduto  UNION SELECT e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e INNER JOIN leitorbm as l ON l.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by l.CODPRODUTO ";
      ...
      <?php
           while($row = mysqli_fetch_assoc($resultsql)) {
                  ...
                  foreach($json->LJSISTEMAS as $arquivo):
                    ...
                    #$row = mysqli_fetch_assoc($resultsql);
                    echo "s";
                    echo $arquivo->CODPRODUTO;
                    echo "+";
                    echo "l";
                    echo $row['CONTAP'];
                    echo "-";
                    if($row['CONTAP'] == $arquivo->CODPRODUTO){
                      echo "aqui";
                      echo "<tr >";
