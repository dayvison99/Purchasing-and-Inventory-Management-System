            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5>Conferir Estoque São Francisco</h5>
                    </div>
                    ...
                    <?php
                        ...
                        //3º Reinicie o servidor http
                            try{
                                require_once 'lj/GetProdutosGradesf.php';
                                ...
                                $result = "DELETE FROM `auxestoquesf`";
                                $queryresult = mysqli_query($con, $result);
                                $zerar = "ALTER TABLE `auxestoquesf` AUTO_INCREMENT=1";
                                ...
                                foreach($json->LJSISTEMAS as $arquivo):
                                  ...
                                  $result = "INSERT INTO auxestoquesf(`empresa`,`codproduto`, `estoque`, `descricao`) VALUES ('$empresa','$codproduto','$estoque','$descricao')";
                                  $queryresult = mysqli_query($con, $result);
                                ...
                                require_once 'lj/SetStatussf.php';
                            } catch (Exception $e) {
                                echo 'Erro ao conectar com o servidor! ';//,  $e->getMessage(), "\n";
                            }

                        if ($queryexcluir){
                                    $zerar1 = "ALTER TABLE `leitorsf` AUTO_INCREMENT=1";
                      ...
                      ?>
                        ...
                        <br/>
                          ...
                          <a class="btn btn-primary" href="leitorsf.php">OK</a>
