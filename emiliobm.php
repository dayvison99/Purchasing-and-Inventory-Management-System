...
?>
      ...
      <div class="jumbotron"><center>
        ...
        <legend class="legend-border"><h4> Lista de Compras Brasília</h4></legend>
        <form action="" method="post" class="form">
          ...
          <table id="tabela" class="table table-striped table-bordered table-condensed table-hover" title="Balanceamento!">
             <tr ><th colspan="2"><a href="imprimiremiliobm.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Imprimir Lista de Compras</button></a></li></th>
                <th colspan="2"><a href="gerar_planilhabm.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Gerar Excel</button></a></li></th>
               <th colspan="4"><a href="marcasbm.php" id="jn"><i class="ion-help"></i> <button type="button" class="btn btn-primary">Voltar</button></a></li></th>
