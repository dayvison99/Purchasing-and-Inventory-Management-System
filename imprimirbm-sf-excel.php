 ...
 <link href="css/sb-admin-2.min.css" rel="stylesheet">
	...
	<body>
		...
		$arquivo = 'BALANCEAMENTO BRASILIA_SAOFRANCISCO.xls';

		// Criamos uma tabela HTML com o formato da planilha
		$html = '';
		$html .= '<table width="467" border="1px">';
		$html .= '<tr>';
		$html .= '<td colspan="5"><center>BALANCEAMENTO BRASÍLIA DE MINAS PARA SÂO FRANCSICO </center></tr>';
		$html .= '</tr>';
    ...
    $html .= '<td><b>Codigo</b></td>';
		...
		$html .= '<td><b>Excendentes BM</b></td>';
    $html .= '<td><b>Minimo SF</b></td>';
		$html .= '<td><b>Para SF</b></td>';
		$html .= '</tr>';
