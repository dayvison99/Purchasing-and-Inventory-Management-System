                    ...
                    <?php
                           ...
                           $tmpString = null;
                              if ($_SESSION['empresa'] == "1"){
                                    $sql = "SELECT t.codproduto as tcodigo,t.DESCPRODUTO as tnome, t.estoque as tentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e right  JOIN leitorconferenciajn as l ON l.codproduto = e.CODPRODUTO inner JOIN auxestoquejn as t ON t.codproduto = e.CONTAPRODUTO where l.id = $tmpString group by e.descproduto  UNION SELECT t.codproduto as codigo,t.DESCPRODUTO as tnome, t.estoque as qtdeentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e left  JOIN leitorconferenciajn as l ON l.codproduto = e.CODPRODUTO left JOIN auxestoquejn as t ON t.codproduto = e.CONTAPRODUTO where l.id = $tmpString  group by e.descproduto  ";
                             }
                              if ($_SESSION['empresa'] == "2"){
                                   $sql = "SELECT t.codproduto as tcodigo,t.DESCPRODUTO as tnome, t.estoque as tentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e right  JOIN leitorconferenciasf as l ON l.codproduto = e.CODPRODUTO inner JOIN auxestoquesf as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 and l.id = $tmpString group by e.descproduto  UNION SELECT t.codproduto as codigo,t.DESCPRODUTO as tnome, t.estoque as qtdeentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e left  JOIN leitorconferenciasf as l ON l.codproduto = e.CODPRODUTO left JOIN auxestoquesf as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 and l.id = $tmpString group by e.descproduto";
                               }
