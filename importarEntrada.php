                      ...
                      <table class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        <tr>
                              ...
                              <div >
                                ...
                                <form action="excluirEntrada.php" method="post" enctype="multipart/form-data" >
                          ...
                          <tr>
                          <th>
                            <form action="importarEntrada2.php" method="post" enctype="multipart/form-data" >
                          ...
                          <tr>
                            <th ><center>  <label for="exampleFormControlFile1"><h5>Click em Conferir para Lançar os Produtos da Entrada<h5></label></center></br>
                                <div >
                                  <center><a href="compras.php" value="Conferir"><button type="submit" class="btn btn-primary">Conferir</button></a>
                                </div></center>
                            </th>
                          </tr>
                        </table>
                  ...
                  <!-- Confimar ser o usuario deseja sair sem salvar-->
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a class="btn btn-info btn-md" href="excluirEntrada.php" value="apagar"> Sim </a>
                                </div>
                              </div>
                              </div>
                              </div>
