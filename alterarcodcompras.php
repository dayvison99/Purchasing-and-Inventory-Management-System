                ...
                <div class="container-fluid">
                    ...
                    <?php
                           ...
                           if ($_SESSION['empresa'] == "1"){
                                   $sql = "SELECT t.codproduto as tcodigo,t.descricao as tnome, t.quantidade as tentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e right  JOIN leitorcomprasjn as l ON l.codproduto = e.CODPRODUTO inner JOIN comprasjn as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 and l.id = $tmpString group by e.descproduto  UNION SELECT t.codproduto as codigo,t.descricao as tnome, t.quantidade as qtdeentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e left  JOIN leitorcomprasjn as l ON l.codproduto = e.CODPRODUTO left JOIN comprasjn as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 and l.id = $tmpString  group by e.descproduto  ";
                            }
                    ...
                    ?>
                                  ...
                                  <form class="needs-validation" action="alterarcodcompras2.php" method="POST">
                                        <div class="form-row">
                                      ...
                                      <button class="btn btn-primary" type="submit">Salvar</button>
                                        <a class="btn btn-primary" href="compras.php">Voltar</a>
                                      </form>
                                    </div>
                                </div>
                            </div>
