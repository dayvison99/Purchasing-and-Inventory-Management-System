        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a class="btn btn-primary" href="excluirbm.php">Nova Leitura</a>
...
<div class="form-group col-xs-6" >
      ...
      <?php
           ...
           $leitor = "SELECT e.CODPRODUTO,e.CONTAPRODUTO,e.DESCPRODUTO as descricao, l.CODPRODUTO as codigo, count(l.codproduto) as quantidade FROM est004 as e INNER JOIN leitorjn as l ON l.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by l.codproduto order by descricao  ";
           $leitorresult = mysqli_query($con, $leitor);

          # $transferencia = "SELECT t.codproduto as codigo,t.nome as tnome, t.quantidadeEntrada as entrada, t.quantidadeSaida as saida, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto FROM trasnferencia as t LEFT OUTER JOIN est004 as e ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by e.DESCPRODUTO order by tnome ";
           #$transferenciaresult = mysqli_query($con, $transferencia);

           #$sql = "SELECT t.codproduto as tcodigo,t.nome as tnome, t.quantidadeEntrada as tentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e right  JOIN leitorjn as l ON l.codproduto = e.CODPRODUTO inner JOIN trasnferencia as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by e.descproduto  UNION SELECT t.codproduto as codigo,t.nome as tnome, t.quantidadeEntrada as qtdeentrada, e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e left  JOIN leitor as l ON l.codproduto = e.CODPRODUTO left JOIN trasnferencia as t ON t.codproduto = e.CONTAPRODUTO where e.empresa = 1 group by e.descproduto  ";
           #$resultsql = mysqli_query($con, $sql);

           $sql = "SELECT e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto as lcodigo,count(l.codproduto) as lqtde FROM est004 as e right  JOIN leitorjn as l ON l.codproduto = e.CODPRODUTO where e.empresa = 1 group by e.descproduto  UNION SELECT e.codproduto,e.CONTAPRODUTO,e.empresa,e.descproduto as descproduto, l.id,l.codproduto,count(l.codproduto) as Qtde FROM est004 as e left  JOIN leitorjn as l ON l.codproduto = e.CODPRODUTO where e.empresa = 1 group by e.descproduto  ";
           $resultsql = mysqli_query($con, $sql);
               ...
               while($row = mysqli_fetch_assoc($resultsql)) {
                  ...
                  if($row['lcodigo'] > 0 or $row['tcodigo'] >0) {
                    if(($row['lcodigo'] != $row['tcodigo'])or($row['lcodigo'] = $row['tcodigo'] and $entrada != $row['lqtde'])) {
                          ...
                          ##LJ SISTEMAS
                          try{
                              require_once 'lj/GetEstoque.php';
                              ...
                              #while($json->LJSISTEMAS as $arquivo){
                              foreach($json->LJSISTEMAS as $arquivo):
                              if($arquivo->CODPRODUTO == 001206){
                                 print $arquivo;
                                 echo "<tr>";
                                  #echo "<td>".($arquivo->DESCPRODUTO);"</td>";
                                #  echo "<td>".($arquivo->CODPRODUTO);"</td>";
                                  #echo "<td>".($arquivo->GRUPO);"</td>";
