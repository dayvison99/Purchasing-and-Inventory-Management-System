            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                              ...
                              echo " Extensão Inválida";
                               ...
                               $recebido = fopen($tmp_name, 'r');
                                ...
                                while(($dados = fgetcsv($recebido,1000, ",")) !== FALSE)
                                {
                                  ...
                                  $un = utf8_encode($dados[2]);
                                  $aplicacao = utf8_encode($dados[3]);
                                  $avista = utf8_encode($dados[4]);
                                  $aprazo = utf8_encode($dados[5]);
                                  $loc = utf8_encode($dados[6]);
                                  $estoque = utf8_encode($dados[7]);
                                  $marca = utf8_encode($dados[8]);



                                    $result = "INSERT INTO estatual(`codproduto`, `descricao`, `un`, `aplicacao`, `avista`, `aprazo`, `loc`, `estoque`, `marca`) VALUES ('$codproduto','$descricao','$un','$aplicacao','$avista','$aprazo','$loc','$estoque','$marca')";
                      ...
                      ?>
                      <br/>
                      <a class="btn btn-primary" href="leitorbm.php">Nova Leitura</a>
