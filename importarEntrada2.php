                              ...
                              return;
                               ...
                               $recebido = fopen($tmp_name, 'r');
                                ...
                                while(($dados = fgetcsv($recebido,1000, ",")) !== FALSE)
                                {
                                  ...
                                  $quantidadeSaida = utf8_encode($dados[3]);
                                  $quantidadeEntrada = utf8_encode($dados[4]);



                                  if ($_SESSION['empresa'] == "1"){
                                        $result = "INSERT INTO comprasjn(`codproduto`, `descricao`, `quantidade`, `pavista`, `pprazo`,`idusuario`) VALUES ('$codproduto','$nome','$marca','$quantidadeSaida','$quantidadeEntrada','$idusuario')";
                                        $result2 = "INSERT INTO leitorcomprasjn(`codproduto`, `diferenca`, `quantidade`, `idusuario`) VALUES ('$codproduto','0','0','$idusuario')";
                                  ...
                                  if ($_SESSION['empresa'] == "2"){
                                        $result = "INSERT INTO comprassf(`codproduto`, `descricao`, `quantidade`, `pavista`, `pprazo`) VALUES ('$codproduto','$nome','$marca','$quantidadeSaida','$quantidadeEntrada')";
                                        $queryresult = mysqli_query($con, $result);

                                  }
                                  if ($_SESSION['empresa'] == "5"){
                                        $result = "INSERT INTO comprasbm(`codproduto`, `descricao`, `quantidade`, `pavista`, `pprazo`) VALUES ('$codproduto','$nome','$marca','$quantidadeSaida','$quantidadeEntrada')";
                                        $queryresult = mysqli_query($con, $result);
                                  }
